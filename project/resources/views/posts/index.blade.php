...
<body>
    <div class="col-md-8 col-md-offset-2">
        <h2 class="text-center">Insertion de musique</h2>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    <li><i class="fa fa-file-text-o"></i> All the current Tracks</li>
                    <a href="#" class="add-modal"><li>Add a Tracks</li></a>
                </ul>
            </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-sm-2" for="title">Quantité</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="title_add" autofocus>
                                <small>Min: 2, Max: 32, only text</small>
                                <p class="errorTitle text-center alert alert-danger hidden"></p>
